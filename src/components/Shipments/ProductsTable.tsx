...
const tableColumns: Array<Column<ShipmentProducts>> = [
  {
...
const ShipmentsProducts: React.FC = () => {
  ...
  let data: ShipmentProducts[] = useMemo(
    (): ShipmentProducts[] =>
      detailedShipments?.products
        ? detailedShipments.products.map((item) => ({
            ...item,
  ...
  const handleClickRow = (args: ShipmentProducts) => {
